...
| `https://ops.boundarylabo.com/api/healthz` | portal 自身 | portal が up しているか（A1-2 で portal.* から ops.* に移行） |
...
# => [cert-checker] starting with 3 host(s), interval 24h: boundarylabo.com, ops.boundarylabo.com, portal.boundarylabo.com
```
